...
public class Project_Serializer {
	...
	public static void main(String[] args) throws IOException {
		...
		projectSerializer.map2.put(project2, projectSerializer.elist2);
		projectSerializer.map3.put(project3, projectSerializer.elist3);
		projectSerializer.serializeProjectDetails(projectSerializer.map1);
		
		try {
			FileOutputStream file = new FileOutputStream("C:\\New folder\\Employee.ser");
